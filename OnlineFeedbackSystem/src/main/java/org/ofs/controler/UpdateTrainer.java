...
public class UpdateTrainer extends HttpServlet {
	...
	//	out.println("<>");
		out.println("<HTML>");
		out.println("<HEAD>");
		out.println("<TITLE>View Update Trainers</TITLE>");
		...
		out.println("<DIV class='port3'>");
		out.println("<DIV class='table-container'>");
		out.println("<DIV class='search-bar'>");
			out.println("<INPUT type='text' onKeyup='searchTrainer2(this.value)' Placeholder='Search Here'>");
			...
			out.println("</SELECT>");
		out.println("</DIV>");
		out.println("<DIV class='up-trainer' id='searchTrainers'>");
		out.println("<TABLE>");
		out.println("<THEAD>");
